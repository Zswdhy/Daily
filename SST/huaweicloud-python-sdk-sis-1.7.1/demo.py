...
def ttsc_example():
    ...
    text = "A child's education has never been about learning information and basic skills only."  # 待合成文本，不超过500字
    path = 'test.wav'  # 保存路径，需要具体到音频文件，如D:/test.wav，可在设置中选择不保存本地
